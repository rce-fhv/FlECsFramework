...
class TestClockModel(unittest.TestCase):
    def test_clock(self):
        ...
        self.assertEqual(clockfun2(7), pd.Timestamp('2024-01-01 07:00:00', tz='Europe/Vienna'))
        self.assertEqual(clockfun2(8), pd.Timestamp('2024-01-01 08:00:00', tz='Europe/Vienna'))